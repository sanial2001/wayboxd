...
export const people: Person[] = [
  ...
  },
  {
    ...
    username: 'arjun',
    name: 'Arjun Mehta',
    bio: 'Bangalore nights, loud rooms, and beer that tastes like a verdict.',
...
export const places: Place[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 2103,
    image: 'https://images.unsplash.com/photo-1751931628616-a359606b318c?w=1200&h=800&fit=crop',
    excerpt: 'Worth every switchback. Then the mountains take over.',
    excerptAuthor: 'kabir',
    categories: ['Trek', 'Mountains'],
    priceRange: '$$',
    bestTime: 'Oct–Nov or Mar–May',
  },
  {
    id: '4',
...
export const reviews: Review[] = [
  ...
  {
    id: '6',
    placeSlug: 'annapurna-base-camp',
    title: 'Worth every switchback. Then the mountains take over.',
    body: 'You earn the last tea house. After that the amphitheatre of snow does the talking, and your phone becomes a very expensive compass.',
    rating: 5,
    author: byUsername.kabir,
    createdAt: '1 day ago',
    photoCount: 1,
...
export const communities: Community[] = [
  ...
  },
  {
    ...
    slug: 'japan',
    name: 'Japan',
    description: 'Trains, temples, convenience stores, and hot takes about both.',
    memberCount: 132000,
    coverImage:
